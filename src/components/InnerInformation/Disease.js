  ...
  return (
    ...
    <div className="acc">
    {
        ...
        <AccordionSummary sx={{color:"#59AD65"}}
          ...
          id="panel1a-header"
        >
          <Typography fontWeight={"bold"} >જમીન જન્ય રોગ મગફળી થડ નો સુકારો (સફેદ ફૂગ) </Typography>
        </AccordionSummary>
        <AccordionDetails sx={{color:'gray'}}>
          <Typography fontSize={15}>
            {"->"} રાસાયણિક નામ :- ટ્રાયકોડર્માં,<br/>
            {"->"} કોમર્શિયલ નામ:- મોનીટર <br/>
            7500g દવાનો ઉપયોગ જમીનમાં ભેજ હોય ત્યારે કરવો
      ...
      <Accordion>
        <AccordionSummary sx={{color:"#59AD65"}}
          ...
          id="panel1a-header"
        >
          <Typography fontWeight={"bold"} >હવા જન્ય રોગ મગફળી થડનો સુકારો (સફેદ ફૂગ) વહેલા લગતા પણ ના ટપકા મોડા લગતા અલ્ટરનેરીયા લીફ બ્લાઈટ  </Typography>
        </AccordionSummary>
        <AccordionDetails sx={{color:'gray'}}>
          <Typography fontSize={15}>
            {"->"} રાસાયણિક નામ :- ટેબુકોનાઝોલ + મેન્કોઝેબ,<br/>
            {"->"} કોમર્શિયલ નામ:- ફોલિકલ / ગોલ્ડ <br/>
